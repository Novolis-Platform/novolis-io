...
| Package | Install |
|---------|---------|
| `Novolis.IO.Git` | `dotnet add package Novolis.IO.Git` |
| `Novolis.IO.Watching` | `dotnet add package Novolis.IO.Watching` |
...
Git, watching, recovery, process jobs, and root discovery helpers for Novolis apps.
